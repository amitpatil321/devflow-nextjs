...
const UserCard = async ({ user }: UserProps) => {
  ...
  return (
    <Link
      ...
      className="shadow-light100_darknone xs:w-[260px] max-xs:min-w-full w-full"
      //   className="shadow-light100_darknone w-full xs:w-[260px] sm:w-[220px] md:w-[200px]"
    >
      <article className="light-border background-light900_dark200 flex w-full flex-col items-center justify-center rounded-2xl border p-8">
        <Image
          src={user.picture}
